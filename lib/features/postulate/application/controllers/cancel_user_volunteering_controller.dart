...
part 'generated/cancel_user_volunteering_controller.g.dart';

@riverpod
class CancelUserVolunteeringController
    extends _$CancelUserVolunteeringController {
  @override
  FutureOr<void> build() {}
  ...
  Future<void> cancel({
    ...
    final userDataEither =
        await ref.read(volunteeringRepositoryProvider).cancelUserVolunteering(
              user: currentUser,
