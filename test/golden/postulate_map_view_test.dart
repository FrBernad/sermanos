...
import 'mocks/providers/postulate_view_mode_controller_map_mock.dart';
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
          ...
          child: ProviderScope(
            overrides: [
              ...
              postulateViewModeControllerProvider
                  .overrideWith(() => PostulateViewModeControllerMapMock())
            ],
      ...
      await expectLater(
        ...
        matchesGoldenFile('./images/postulate_map_view.png'),
      );
    },
  );
}
